...
def read_airline_data(airlines="/Users/adityakalyanjayanti/PycharmProjects/Analyzing-Trends-between-Airline-Crude-Oil/Data/airlines_IATA.csv"):
    """
...
def visualize_airline_statistics(df, airline_data, airline_statistics=""):
    ...
    ax3 = sns.stripplot(y="OP_CARRIER", x="DEP_DELAY", size=4, data=df2, linewidth=0.5, jitter=True)
    ...
    plt.savefig('/Users/adityakalyanjayanti/PycharmProjects/Analyzing-Trends-between-Airline-Crude-Oil/Results/AirlineDelays.png', bbox_inches='tight')
    plt.show()
    plt.close()
